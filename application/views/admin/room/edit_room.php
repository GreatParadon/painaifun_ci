...
<div class="box box-success">
  ...
  <div class="box-body">
	<form class="form-horizontal" role="form" action="<?= base_url('admin/room/update/'.$room_edit['room_id'].'') ?>" method="POST" enctype="multipart/form-data" runat="server" id="brandform">
   <table class="table table-responsive" style="width:100%">
		<tr>
			<td><label>Room ID : </label>
				<input type="text" name="room_id" id="room_id" class="form-control input-sm" maxlength="7" value="<?= $room_edit['room_id']?>" readonly>
			</td>
		</tr>
		<tr>
			<td><label>Room Name : </label>
				<input type="text" name="room_name" id="room_name" class="form-control input-sm" value="<?= $room_edit['room_name']?>" maxlength="100" required>
			</td>
		</tr>
		<tr>
			<td><label>Room Detail : </label>
				<textarea name="room_detail" id="room_detail" class="form-control input-sm" required><?= $room_edit['room_detail']?></textarea>
			</td>
		</tr>
		<tr>
