            ...
            <table class="table table-hover table-responsive">
                ...
                <?php
                    foreach ($room_select as $r) {
                        ...
                        $editpath = base_url('admin/room/'.$r["room_id"].'/edit');
                     print '<tr>
                            <td>' . $r["room_id"] . '</td>
                            <td>' . $r["room_name"]  . '</td>
                            <td><a href="'.$editpath.'" class="btn btn-default">EDIT</a>
                            <button onclick="deleteRoom(' . $r["room_id"] . ')" class="btn btn-default">DELETE</button></td>
                            </tr>';
                        }
                ?>
                </tbody>
...
<script type="text/javascript">
    ...
    function deleteRoom(id){
        var url = "<?= base_url('admin/room/delete/"+id+"') ?>";
